...
class HomeController
{
    ...
    public function index()
    {
        ...
        return view('frontend.index', compact('faqs', 'university', 'about', 'galary', 'competition', 'competition_year', 'competition_type', 'product', 'sliders', 'event', 'brands', 'services', 'testmonies', 'blogs', 'projects', 'service_count', 'service_header', 'areas', 'branches'));
    }
