...
class SettingController extends Controller
{
  ...
  public function projectstore(Request $request)
  {
    ...
    foreach ($request->title  as $key => $title) {
      ...
      if ($request->image3 != null) {
        ...
        $image = $request->image3[$key]->move(public_path('setting/banner'), $newImageName3);
      }
      if ($request->banner != null) {
  ...
  public function brandstore(Request $request)
  {
    if ($request->banner_image) {
      $newImageName = time() . '.' . $request->banner_image->extension();
      $image = $request->banner_image->move(public_path('setting/brand'), $newImageName);
    }
  ...
  public function brandupdate(Request $request)
  {
    ...
    if ($request->image) {
      $newImageName = time() . '.' . $request->image->extension();
      $image = $request->image->move(public_path('setting/brand'), $newImageName);
    } else {
      $newImageName = $request->oldimage;
    }
  ...
  public function branch()
  {
      ...
      return view('backend.content.settings.branch.branch', compact('branches'));
  }
  ...
  public function branchstore(Request $request)
  {
      ...
      return back()->withFlashSuccess('Branch Location Added Successfully');
  }

  public function branchedit($id)
  {
      $branch = Branch::find($id);
      return view('backend.content.settings.branch.edit', compact('branch'));
  }
  ...
  public function branchupdate(Request $request)
  {
      ...
      return back()->withFlashSuccess('Branch Location Updated Successfully');
  }
  ...
  public function branchdelete($id)
  {
      ...
      if ($branch) {
          $branch->delete();
          return back()->withFlashSuccess('Branch Location Deleted Successfully');
      }
      return back()->withFlashDanger('Branch Location Not Found');
  }
}
